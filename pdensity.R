...
setwd('/work/Rproject/Sanfransisco')
...
#dcat1 <- fread('pdens/dcat1.csv', header = FALSE, sep=",", check.names = FALSE)
...
all_sub <- all[,.(MinuteAbs30, Hour, AddressTypeIsOf, Year, pcx, pcy, pcxy)]
